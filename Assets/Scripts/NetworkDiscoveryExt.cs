...
[Serializable]
public class ServerFoundExtUnityEvent : UnityEvent<DiscoveryResponse> { };

public class NetworkDiscoveryExt : NetworkDiscoveryBase<DiscoveryRequest, DiscoveryResponse>
{
  ...
  public ServerFoundExtUnityEvent OnServerFound;
